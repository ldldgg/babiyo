	...
	$('#orderBtn').click(function(){
		...
		if(totalAmount > balance){
			...
			if(confirm('충전을 하시겠습니까?')){
				location.href = '/babiyo/member/cash/charge';
			}
...
<div id="rootDiv">
	...
	<div id="middleDiv">
		...
		<div id="receiverDiv">
			...
			<form action="./order/${_memberDto_.id}" method="post" id="receiverForm">
				...
				<div>
					<c:forEach items="${orderDetailList}" var="order" varStatus="status">
						...
						<input type="hidden" name="orderDetailList[${status.index}].productName" value="${order.productName}">
