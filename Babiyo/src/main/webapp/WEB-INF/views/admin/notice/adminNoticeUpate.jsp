...
function pageMoveDeleteFnc(no){
	if (confirm('삭제하시겠습니까?')) {
		$('#modifyForm').attr('action', './' + no + '/remove');
		$('#modifyForm').submit();
	}
}
</script>
	...
	<div id="middleDiv">
		...
		<div id="middleMainDiv">
			...
			<!--여기서 작성 -->
				...
				<form id="modifyForm" name="frm" action="./${noticeDto.no}/modify" method="post" enctype="multipart/form-data"
					...
					<div>
						<div id='fileContent'>
							...
							<c:choose>		
							<c:when test="${not empty noticeImg}">
							<div>
								<input type="hidden" name="imgNo" value="${noticeImg.no}">
								<div>
									<img id="imgSize" alt="image not found" src="/babiyo/img/${noticeImg.storedName}">
								</div>
								${noticeImg.originalName}
					...
					<div id="btnDiv">
						<input class="backBtn" type="button" value="뒤로가기" onclick="pageMoveBeforeFnc();">
