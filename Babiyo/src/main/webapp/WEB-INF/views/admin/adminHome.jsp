			...
			<div id="stateContainer">
				<div id="orderState">
					...
					<div id="orderContent" class="stateContent">
						<span class="stateCount"><a href="./orders">${countMap.orderCount}</a></span>
						<span>건</span>
					</div>
				</div>
				<div id="inquiryState">
					...
					<div id="inquiryContent" class="stateContent">
						<span class="stateCount"><a href="./inquiry">${countMap.inquiryCount}</a></span>
						<span>건</span>
					</div>
				</div>
			</div>
