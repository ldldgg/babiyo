...
<div id="rootDiv">
	...
	<div id="middleDiv">
		...
		<div id="middleMainDiv">
			...
			<form name="frm" method="post" onsubmit="return formSubmit();">
			<input type="hidden" id="memberId" name="memberId" value="${inquiryDto.memberId}">
			...
			<div>
				...
				<%-- <span>분류</span>
				<input type="text" name="name" id="divisionId" value="${inquiryDto.name}" > --%>
			</div>
			<div id="titleDiv">
				<span>제목</span> 
