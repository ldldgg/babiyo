...
$(document).ready(function(){
		...
		midObj.addEventListener('keyup', function() {
			...
			if (midObj.value == '') {
				...
				$.ajax({
			        url:'./idCheckCtr', //Controller에서 요청 받을 주소
		...
		emailObj.addEventListener('keyup', function() {
			...
			if (emailObj.value == '') {
				...
				$.ajax({
			        url:'./emailCheckCtr', //Controller에서 요청 받을 주소
			        type:'post', //POST 방식으로 전달
			        data:{email:email},
			        success:function(cnt){ //컨트롤러에서 넘어온 cnt값을 받는다 
		...
		phoneObj.addEventListener('keyup', function() {
			...
			if (phoneObj.value == '') {
				...
				$.ajax({
			        url:'./phoneCheckCtr', //Controller에서 요청 받을 주소
			        type:'post', //POST 방식으로 전달
			        data:{phone:phone},
			        success:function(cnt){ //컨트롤러에서 넘어온 cnt값을 받는다 
		...
		nicknameObj.addEventListener('keyup', function() {
			if (nicknameObj.value == '') {
				...
				$.ajax({
			        url:'./nicknameCheckCtr', //Controller에서 요청 받을 주소
			        type:'post', //POST 방식으로 전달
