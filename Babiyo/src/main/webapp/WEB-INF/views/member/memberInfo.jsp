...
<!-- 							<th>내가 쓴 리뷰</th> -->
						...
						<tr>
							<td><a href="./orders">${countMap.orderCount}건</a></td>
							<td><a href="./inquiry">${countMap.inquiryCount}건</a></td>
<%-- 							<td><a href="../review/myReview">${countMap.reviewCount}건</a></td> --%>
							<td><a href="./cash">${_memberDto_.cash}원</a></td>
						</tr>
					</table>
				<div id="modifyDate">		
					<p>최근 정보 수정일</p>
