			...
			<div>
				<ul id='loginMethodList'>
					<li><a style="border-right: 1px; border-right-color: grey;"
						href="/babiyo/auth/findId">아이디 찾기</a></li>
					<li id='verticalLine'></li>
					<li><a href="/babiyo/auth/findPwd">비밀번호 찾기</a></li>
				</ul>
			</div>
			<div>
				<form method="post">
					...
					<div>
						...
						<input type="button" class="btn" id="memberAddBtn" value="회원가입"
							onclick="location.href='/babiyo/auth/member/add'">
					</div>
				</form>
			</div>
		</div>
