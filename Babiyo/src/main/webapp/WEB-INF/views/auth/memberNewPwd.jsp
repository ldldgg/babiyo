...
<body>
	<div id='wrap'>
		...
		<div id='bodyDiv'>
			...
			<input id='findId' type="button" value='아이디 찾기' onclick='goFindIdFnc();'> 
			<input id='findPwd' type="button" value='비밀번호 찾기' onclick="goFindPwdFnc();">
			<p>새로운 비밀번호 설정</p>
			<form action="./newPwd" method="post">
				...
				<div id='lowerButtonDiv'>
					<input class="btn" type="button" value="뒤로" onclick="location.href='/babiyo/auth/login'">
					<input id="findBtn" class="btn" type="button" value="변경하기">
				</div>
			</form>
		</div>
	</div>
