	...
	<div id="middleDiv">
		...
		<div id='productCategoryName'>
			...
			<c:forEach var="productCategory" items="${productCategory}">
				<span id='productCategoryName${productCategory.code}' 
					onclick="categorySelect(${productCategory.code});">
						...
						<div class='category'>
							<div class='productContent'>
								<div class='productContentImage'>
									<a href="/babiyo/product/${category.productDto.no}">
										<img alt="${category.productDto.name}" 
											src="/babiyo/img/${category.imgMap.storedName}"></a>				
								</div>
